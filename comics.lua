  ...
  print( "inside showNext" )
	if readyToContinue then
      ...
      print( "inside showNext: panel1" )
		...
		elseif panel == 2 then
      print( "inside showNext: panel2" )
			panel1.isVisible = false
			panel2.alpha = 1
			panel2.x = display.contentWidth + panel2.contentWidth
			panel2.isVisible = true
			pageTween = transition.to( panel2, { time=tweenTime, x=display.contentWidth*0.5, transition=easing.outExpo, onComplete=completeTween } )
		
		elseif panel == 3 then
      print( "inside showNext: panel3" )
			panel2.isVisible = false
			panel3.alpha = 1
			panel3.x = display.contentWidth + panel3.contentWidth
			panel3.isVisible = true
			pageTween = transition.to( panel3, { time=tweenTime, x=display.contentWidth*0.5, transition=easing.outExpo, onComplete=completeTween } )

		elseif panel == 4 then
      print( "inside showNext: panel4" )
			panel3.isVisible = false
			panel4.alpha = 1
			panel4.x = display.contentWidth + panel4.contentWidth
			panel4.isVisible = true
			pageTween = transition.to( panel4, { time=tweenTime, x=display.contentWidth*0.5, transition=easing.outExpo, onComplete=completeTween } )
